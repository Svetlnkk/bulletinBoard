            ...
            <v-col class="col-12 col-sm-10 col-md-10 col-lg-8 col-xl-6 mx-auto">
                ...
                >
                    ...
                    <v-col class="pa-0 mb-1">
                        <h1
                            class="ad-main__title text--primary font-weight-medium"
                        >
                            {{ ad.title }}
                        </h1>
                    </v-col>
                    ...
                    <v-col class="pt-0">
                        ...
                        >
                            <v-icon
                                class="ad-main__circle teal--text"
                                size="small"
                            >
                                mdi-circle
                            </v-icon>
                    ...
                    <v-col class="pa-2">
                        <div
                            class="ad-main__date text-body-2 text-sm-subtitle-1"
                        >
                            <v-icon
                                class="ad-main__icon pr-1 mb-1"
                                color="teal"
                            >
                                mdi-currency-usd
                            </v-icon>
